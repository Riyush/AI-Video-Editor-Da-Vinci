...
def detect_silences_in_media(audio_tracks:dict, silence_thresh_db: float = -40.0, min_silence_len_sec: float = 1.0) ->dict:
    # Play with the silence threshold a little bit. I want to dynamically set the silence threshold,
    # and also filter out media based on other criteria. 
    """
